...
class TestConfig(unittest.TestCase):
    ...
    def test_datetime_data_feed_created_with_empty_options(self):
        date_time_feed = DateTimeFeedConfig().create(self._EMPTY_OPTIONS, self._EMPTY_SECRET_STORE)
...
class TestFeed(unittest.TestCase):
    ...
    def test_feed_returns_date_and_time(self):
        data_feed = DateTimeFeedConfig().create(self._EMPTY_OPTIONS, self._EMPTY_OPTIONS)
